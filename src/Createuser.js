...
function Createuser() {
    ...
    const myFormik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                setLoading(true);
                await axios.post("https://62b6abce42c6473c4b4653d7.mockapi.io/users", values);
            ...
            <form onSubmit={myFormik.handleSubmit}>
                <div className='row'>
                    ...
                    <div className='col-lg-3 mt-3'>
                        <input type="submit" disabled={isLoading} value={isLoading ? "creating..." : "Create"} className='btn btn-primary' />
                    </div>
